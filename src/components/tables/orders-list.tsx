    ...
    <div className="space-y-4">
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <Input
          ...
          className="sm:w-44 h-[50px] rounded-lg"
          style={{ backgroundColor: "#F5F5F5", border: "1px solid #F5F5F5", boxShadow: "none" }}
        />
        <Select value={pay} onValueChange={setPay}>
          <SelectTrigger className="sm:w-44 h-[50px] rounded-lg" style={{ backgroundColor: "#F5F5F5", border: "1px solid #F5F5F5", boxShadow: "none" }}>
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
