...
type Props =
  | { state: "loading" }
  | { state: "error" }
  | { state: "ready"; order: Order };

export function OrderConfirmationScreen(props: Props) {
      ...
      <div className="max-w-xl mx-auto">
        <div className="card-soft p-8 text-center">
          <div className="animate-pulse space-y-4">
            ...
            <div className="h-4 bg-muted rounded w-64 mx-auto mb-6" />
        ...
        <div className="card-soft p-8 text-center">
          ...
          <div className="flex gap-3">
            ...
            <Button asChild className="flex-1 gradient-primary text-primary-foreground">
              <Link to="/pos" search={{ page: 1, per_page: 12, q: "" }}>
                New Order
              </Link>
            </Button>
          </div>
