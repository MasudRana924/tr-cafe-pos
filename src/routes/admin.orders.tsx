...
function OrdersPage() {
  ...
  const filtered = orders.filter(
    (o) =>
      (o.id.toLowerCase().includes(q.toLowerCase()) || o.seller.toLowerCase().includes(q.toLowerCase())) &&
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="relative">
          ...
          <Input value={q} onChange={(e) => setQ(e.target.value)} placeholder="Search by order ID or seller..." className="pl-9" style={{ width: "510px", height: "50px", borderRadius: "16px", backgroundColor: "#F5F5F5", border: "1px solid #F5F5F5", boxShadow: "none" }} />
        </div>
